...
# Important events to display in demo mode
IMPORTANT_EVENTS = {
    "kickoff", "goal", "own_goal", "penalty", "penalty_saved",
    "red_card", "yellow_card", "var_review", "shot_on_target",
    "substitution", "injury", "half_time", "second_half", "full_time"
}
